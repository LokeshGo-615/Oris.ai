...
function NavSection({ label, items, pathname }: NavSectionProps) {
    return (
        <SidebarGroup>
            {label && (<SidebarGroupLabel className="text-[13px] uppercase text-muted-foreground">
                {label}
            </SidebarGroupLabel>)}
            <SidebarGroupContent>
                <SidebarMenu>
        ...
        <Sidebar collapsible="icon">
            <SidebarHeader className = "flex flex-col gap-4 pt-4">
                <div className="flex items-center gap-2 pl-1 group-data-[collapsible='icon']:justify-center group-data-[collapsible='icon']:pl-0">
                    ...
                    />
                    <span className="group-data-[collapsible='icon']:hidden font-semibold text-lg tracking-tighter text-foreground">Oris</span>
