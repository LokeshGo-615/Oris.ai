...
export const quickActions: QuickAction[] = [
    {
        ...
        gradient: "from-cyan-400 to_cyan-50",
        href: "/text-to-speech?text = In a village tucked betwwen mist-covered mountains , there lived an old clockmaker whose clocks never told the right time - but they always told the truth. One rainy evening , a stranger walked in and asked for a clock that could show him his future."
    },
    {
        title: "Record an Ad",
